  ...
  public partial class MainWindow : Window {
    ...
    private async Task LoadDriverRepositoryAsync() {
      try {
        ...
        await _driverRepoService.LoadDriverMappingAsync();
        RepoStatusText.Text = "✅ База драйверов загружена";
        ResultText.Text = "✅ База драйверов успешно загружена. Можете сканировать сеть.";
      }
      catch (Exception ex) {
